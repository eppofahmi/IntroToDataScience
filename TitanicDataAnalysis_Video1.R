...
# menambahkan kolom (variabel) survived pada data `test` dan diisi dengan string `none`
...
# mengubah kolom `survived` dan `pclass` menjadi factor
...
# 0 = not survived, 1 = survived, none = unidentified because its come from test data

# Load up ggplot2 package to use for visualizations
library(ggplot2)

# Hypothesis - Rich folks survived at a higer rate
# hipotesis dibuat dari data `train` secar visual 
...
# NOTE - The code below uses a for loop which is not a very R way of doing things
titles <- NULL
